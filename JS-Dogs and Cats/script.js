...
// METHOD 1.
// const calcAvgDog = function (ages) {
//   const dogAge = ages.map((ages) => (ages <= 2 ? ages * 2 : 16 + ages * 4));
//   const dogFilter = dogAge.filter((dog) => dog > 18);

//   const dogAvg = dogFilter.reduce((acc, curr, i, arr) => acc + curr / arr.length, 0);
...
console.log(calcAvgDog(dogs1));
console.log(calcAvgDog(dogs2));
